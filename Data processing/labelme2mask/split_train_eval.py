...
if __name__ == '__main__':
    ...
    # 原始数据集路径
    origion_path = r"E:\data\image_segmentation_test\train\Images"

    # 保存路径
    save_train_dir = r'E:\data\image_segmentation_test\train/train/'
    save_test_dir = r'E:\data\image_segmentation_test\train/test/'
