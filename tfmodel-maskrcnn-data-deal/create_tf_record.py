...
python3 create_tf_record.py --images_dir=path_to_images_dir --annotations_json_dir=path_to_train_annotations_json_dir --label_map_path=path_to_label_map.pbtxt --output_path=path_to_train.record        
...
flags.DEFINE_string('images_dir', r'F:\A_I\models-master\research\object_detection\my_maskrcnn\maskrcnn-data-deal\light_group\init\img', 'Path to images directory.')
flags.DEFINE_string('annotations_json_dir', r'F:\A_I\models-master\research\object_detection\my_maskrcnn\maskrcnn-data-deal\light_group\init\ann',
                    'Path to annotations directory.')
flags.DEFINE_string('label_map_path', r'F:\A_I\models-master\research\object_detection\my_maskrcnn\maskrcnn-data-deal\label_map.pbtxt', 'Path to label map proto.')
flags.DEFINE_string('output_path', r'F:\A_I\models-master\research\object_detection\my_maskrcnn\maskrcnn-data-deal\train.record', 'Path to the output tfrecord.')
...
#        raise ValueError('`annotation_json_path` is not exist.')
    ...
    image_relative_path = os.path.basename(annotation_json_path).split(".")[0]+".jpg"
