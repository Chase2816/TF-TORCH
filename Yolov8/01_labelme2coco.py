...
def main():
    ...
    # F:\data\light_group_rx_total\images\rotatedest
    root = 'D:/data/Temperature/test/'
    input_dir = os.path.join(root, 'total_detect/')
    output_dir = os.path.join(root, 'total_detect_coco/')
    ...
    for image_id, filename in enumerate(label_files):
        ...
        if not noviz:
            ...
            if masks:
                ...
                listdata = zip(listdata_labels,
                               listdata_captions, listdata_masks)
