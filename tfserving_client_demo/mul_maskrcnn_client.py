...
def resize_predictions_detection_masks(image_shape=('height', 'width', 'channels'), mask_threshold=0.):
    ...
    # preds = requests.post("http://10.243.167.172:8001/v1/models/model-pv_lg_wide:predict", json=data)
    # preds = requests.post("http://10.8.111.172::8001/v1/models/model-pv_lg_wide:predict", json=data)
