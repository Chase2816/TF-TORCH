...
from tfv3.utils import load_coco_names, draw_boxes, get_boxes_and_inputs, get_boxes_and_inputs_pb, non_max_suppression, \
                  load_graph, letter_box_image

FLAGS = tf.app.flags.FLAGS

"""
python yolo_v3_demo.py --input_img stain2diode.jpg --output_img sd2.jpg --frozen_model frozen_darknet_yolov3_model.pb --class_names coco.names --data_format NHWC

python yolo_v3_demo.py --input_img diode.jpg --output_img diode-out.jpg --frozen_model 0613_hot_model.pb --class_names coco.names --data_format NHWC
...
def main(argv=None):
    ...
    print(f"dete:{detected_boxes.shape}")
    print(detected_boxes[:,:,0])
    filtered_boxes = non_max_suppression(detected_boxes,
                                         confidence_threshold=FLAGS.conf_threshold,
                                         iou_threshold=FLAGS.iou_threshold)
    print(f"bbox:{filtered_boxes}")
