...
if __name__ == '__main__':
    # labelme 修改1600*1600图片尺寸为800*800  json标注点point同比例缩放
    # src_dir = r'F:\data\mountain0727\light_group\test_data\new_json'
    # dst_dir = r'F:\data\mountain0727\light_group\test_data\da_yjb-lg'
    ...
    # 修改lebleme得json文件标签label
    json_files = r"F:\data\mountain0727\light_group\新建文件夹\test"
    save_json = r"F:\data\mountain0727\light_group\新建文件夹\new_json"
    reset_label(json_files,save_json)

    # 对label标注好后进行修改，包含image和json得重命名，json文件中label标签修改，imagepath修改，imagedata修改等。。。