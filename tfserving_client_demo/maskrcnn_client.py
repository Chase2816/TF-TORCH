...
def resize_predictions_detection_masks(image_shape=('height', 'width', 'channels'), mask_threshold=0.):
    ...
    preds = requests.post("http://10.8.129.183:8001/v1/models/model-pv_lg_wide:predict", json=data)
...
img_path = r"F:\data\box_transformer\box_hot_yolov3\data\AH_hexianhot_1_1_yc1066xc532.jpg"
